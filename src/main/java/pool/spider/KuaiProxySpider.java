...
public class KuaiProxySpider extends ProxySpider implements Spiders{
	...
	private static final String  CHINA_ORIGIN_URL = "http://www.kuaidaili.com/free/inha/";

	private static final String  FOREIGN_ORIGIN_URL  = "http://www.kuaidaili.com/free/outha/";
	...
	public  void start() {
		...
		for(int i=1; i<=3; i++){
			String url = CHINA_ORIGIN_URL + i + "/";
			urls.add(url);
			String url2 = FOREIGN_ORIGIN_URL + i +"/";
			urls.add(url2);
		}
